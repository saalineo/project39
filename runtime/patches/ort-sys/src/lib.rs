...
impl Default for OrtThreadPoolCallbacksConfig {
	fn default() -> Self {
		Self {
			version: 0,
			on_enqueue: None,
...
impl Default for OrtEnvCreationOptions {
	fn default() -> Self {
		Self {
			version: 0,
			logging_severity_level: 0,
			log_id: core::ptr::null(),
			custom_logging_function: None,
			custom_logging_param: core::ptr::null_mut(),
			threading_options: core::ptr::null(),
			config_entries: core::ptr::null(),
		}
	}
}
